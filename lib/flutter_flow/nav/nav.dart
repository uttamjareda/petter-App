...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'WelcomeScreen_Page',
          path: '/welcomeScreenPage',
          builder: (context, params) => const WelcomeScreenPageWidget(),
        ),
        FFRoute(
          name: 'Login_Signup_Page',
          path: '/loginSignupPage',
          builder: (context, params) => const LoginSignupPageWidget(),
        ),
        FFRoute(
          name: 'Enter_OTP_Page',
          path: '/enterOTPPage',
          builder: (context, params) => const EnterOTPPageWidget(),
        ),
        FFRoute(
          name: 'Home',
          path: '/home',
        ...
        FFRoute(
          name: 'bookingDetailsSuccess',
          path: '/bookingDetailsSuccess',
          builder: (context, params) => const BookingDetailsSuccessWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'emptyCart',
          path: '/emptyCart',
          builder: (context, params) => const EmptyCartWidget(),
        ),
        FFRoute(
          name: 'cart',
          path: '/cart',
        ...
        FFRoute(
          name: 'petProfile',
          path: '/petProfile',
          builder: (context, params) => const PetProfileWidget(),
        ),
        FFRoute(
          name: 'bloodTest',
          path: '/bloodTest',
          builder: (context, params) => const BloodTestWidget(),
        ),
        FFRoute(
          name: 'userProfile',
          path: '/userProfile',
        ...
        FFRoute(
          ...
          path: '/petProfileCopy',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'petProfileCopy')
              : const PetProfileCopyWidget(),
        )
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/Petter_-_App_welcome_page.png',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
