...
import 'pet_profile_medical_model.dart';
export 'pet_profile_medical_model.dart';

class PetProfileMedicalWidget extends StatefulWidget {
  const PetProfileMedicalWidget({
    super.key,
  ...
  @override
  State<PetProfileMedicalWidget> createState() =>
      _PetProfileMedicalWidgetState();
}

class _PetProfileMedicalWidgetState extends State<PetProfileMedicalWidget> {
  late PetProfileMedicalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PetProfileMedicalModel());
  }
                    ...
                    child: StreamBuilder<List<DocumentsRecord>>(
                      stream: queryDocumentsRecord(
                        queryBuilder: (documentsRecord) => documentsRecord
                            ...
                            .where(
                              'type',
                              isEqualTo: DocumentType.Medical.serialize(),
                            )
                            .orderBy('created_at'),
                      ),
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            'List of all medical records of your pet.',
