...
import 'homevet_services_details_model.dart';
export 'homevet_services_details_model.dart';

class HomevetServicesDetailsWidget extends StatefulWidget {
  const HomevetServicesDetailsWidget({
    super.key,
  ...
  @override
  State<HomevetServicesDetailsWidget> createState() =>
      _HomevetServicesDetailsWidgetState();
}

class _HomevetServicesDetailsWidgetState
    extends State<HomevetServicesDetailsWidget> {
  late HomevetServicesDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomevetServicesDetailsModel());
  }
