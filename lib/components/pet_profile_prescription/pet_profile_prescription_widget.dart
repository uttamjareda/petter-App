...
import 'pet_profile_prescription_model.dart';
export 'pet_profile_prescription_model.dart';

class PetProfilePrescriptionWidget extends StatefulWidget {
  const PetProfilePrescriptionWidget({
    super.key,
  ...
  @override
  State<PetProfilePrescriptionWidget> createState() =>
      _PetProfilePrescriptionWidgetState();
}

class _PetProfilePrescriptionWidgetState
    extends State<PetProfilePrescriptionWidget> {
  late PetProfilePrescriptionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PetProfilePrescriptionModel());
  }
                    ...
                    child: StreamBuilder<List<DocumentsRecord>>(
                      stream: queryDocumentsRecord(
                        queryBuilder: (documentsRecord) => documentsRecord
                            ...
                            .where(
                              'type',
                              isEqualTo: DocumentType.Prescription.serialize(),
                            )
                            .orderBy('created_at'),
                      ),
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            'List of all prescription of your pet.',
