...
import 'travel_certificate_details_model.dart';
export 'travel_certificate_details_model.dart';

class TravelCertificateDetailsWidget extends StatefulWidget {
  const TravelCertificateDetailsWidget({super.key});

  @override
  State<TravelCertificateDetailsWidget> createState() =>
      _TravelCertificateDetailsWidgetState();
}

class _TravelCertificateDetailsWidgetState
    extends State<TravelCertificateDetailsWidget> {
  late TravelCertificateDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TravelCertificateDetailsModel());
  }
          ...
          StreamBuilder<List<ServicesRecord>>(
            stream: queryServicesRecord(
              queryBuilder: (servicesRecord) => servicesRecord.where(
                'service_category',
                isEqualTo: ServiceCategory.travelCertificate.serialize(),
              ),
              singleRecord: true,
            ),
