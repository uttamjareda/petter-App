...
import 'upcoming_bookings_copy_model.dart';
export 'upcoming_bookings_copy_model.dart';

class UpcomingBookingsCopyWidget extends StatefulWidget {
  const UpcomingBookingsCopyWidget({super.key});

  @override
  State<UpcomingBookingsCopyWidget> createState() =>
      _UpcomingBookingsCopyWidgetState();
}

class _UpcomingBookingsCopyWidgetState extends State<UpcomingBookingsCopyWidget>
    with TickerProviderStateMixin {
  late UpcomingBookingsCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpcomingBookingsCopyModel());
  }
