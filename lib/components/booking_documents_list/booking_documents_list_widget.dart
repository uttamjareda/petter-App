...
import 'booking_documents_list_model.dart';
export 'booking_documents_list_model.dart';

class BookingDocumentsListWidget extends StatefulWidget {
  const BookingDocumentsListWidget({
    super.key,
  ...
  @override
  State<BookingDocumentsListWidget> createState() =>
      _BookingDocumentsListWidgetState();
}

class _BookingDocumentsListWidgetState
    extends State<BookingDocumentsListWidget> {
  late BookingDocumentsListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BookingDocumentsListModel());
  }
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            'List of all prescription / vaccination / medical records.',
