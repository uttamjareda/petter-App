...
import 'previous_bookings_model.dart';
export 'previous_bookings_model.dart';

class PreviousBookingsWidget extends StatefulWidget {
  const PreviousBookingsWidget({super.key});

  @override
  State<PreviousBookingsWidget> createState() => _PreviousBookingsWidgetState();
}

class _PreviousBookingsWidgetState extends State<PreviousBookingsWidget>
    with TickerProviderStateMixin {
  late PreviousBookingsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PreviousBookingsModel());
  }
