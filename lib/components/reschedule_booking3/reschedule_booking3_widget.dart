...
import 'reschedule_booking3_model.dart';
export 'reschedule_booking3_model.dart';

class RescheduleBooking3Widget extends StatefulWidget {
  const RescheduleBooking3Widget({
    super.key,
  ...
  @override
  State<RescheduleBooking3Widget> createState() =>
      _RescheduleBooking3WidgetState();
}

class _RescheduleBooking3WidgetState extends State<RescheduleBooking3Widget> {
  late RescheduleBooking3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RescheduleBooking3Model());
  }
                    ...
                    child: Row(
                      ...
                      children: [
                        FlutterFlowDropDown<String>(
                          ...
                          options: List<String>.from(functions.nextFiveDays()!),
                          optionLabels: const [
                            'Friday, 13 Sept',
                            'Saturday, 14 Sept',
                            'Sunday, 15 Sept'
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            ...
                            await widget.bookingDoc!.reference
                              ...
                              date: _model.dateDropDownValue,
                              dateDateTime:
                                  functions.getDateTimeFromFormattedString(
                                      _model.dateDropDownValue),
                              startTime: _model.timeSlotDropDownValue,
                            ));
                            Navigator.pop(context);
