...
import 'vaccination_details_model.dart';
export 'vaccination_details_model.dart';

class VaccinationDetailsWidget extends StatefulWidget {
  const VaccinationDetailsWidget({
    super.key,
  ...
  @override
  State<VaccinationDetailsWidget> createState() =>
      _VaccinationDetailsWidgetState();
}

class _VaccinationDetailsWidgetState extends State<VaccinationDetailsWidget> {
  late VaccinationDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VaccinationDetailsModel());
  }
